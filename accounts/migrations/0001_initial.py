    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_id', models.CharField(max_length=20, unique=True, verbose_name='شماره شناسایی')),
                ('password_hash', models.CharField(blank=True, max_length=255)),
                ('role', models.CharField(choices=[('student', 'دانشجو'), ('professor', 'استاد'), ('staff', 'کارمند'), ('technician', 'تکنسین'), ('admin', 'مدیر')], default='student', max_length=20, verbose_name='نقش')),
                ...
                ('id_card_image', models.ImageField(blank=True, null=True, upload_to='id_cards/', verbose_name='تصویر کارت شناسایی')),
